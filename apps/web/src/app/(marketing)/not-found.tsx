...
export default function MarketingNotFound() {
  return (
    <div className="relative flex min-h-[60svh] items-center justify-center overflow-hidden py-20">
      <div
        aria-hidden
      ...
      <Container className="flex flex-col items-center gap-6 text-center">
        ...
        <div className="flex flex-col gap-2">
          <p className="font-heading text-7xl font-semibold tracking-tight text-foreground sm:text-8xl">404</p>
