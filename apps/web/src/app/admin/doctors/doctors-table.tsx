...
export function AdminDoctorsTable({ doctors }: { doctors: Doctor[] }) {
  return (
    <>
      <PageHeader
        title="Doctors"
      ...
      <Card className="ring-foreground/5">
        <CardContent>
          <Table>
            ...
            <TableBody>
              {doctors.map((doctor) => {
                const availableToday = doctor.availableToday
                return (
                    ...
                    <TableCell className="text-right">
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                          <DropdownMenuItem
                            onClick={() => toast("Approve/suspend isn't available yet — no status field on doctors")}
                          >
