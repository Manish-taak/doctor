...
const iconOptions = ["Heart", "Baby", "Brain", "Bone", "Eye", "Stethoscope", "Smile", "Activity"]
            ...
            <DialogContent>
              ...
              <div className="flex flex-col gap-4">
                <div className="flex flex-col gap-1.5">
                  ...
                  <Input id="category-name" placeholder="e.g. Oncology" />
                </div>
                <div className="flex flex-col gap-1.5">
                  <Label htmlFor="category-icon">Icon</Label>
                  <Select defaultValue={iconOptions[0]}>
          ...
          <Card key={category.id} className="ring-foreground/5">
            <CardContent className="flex flex-col items-start gap-3">
              ...
              <div className="flex flex-col gap-0.5">
                ...
                <p className="text-sm text-muted-foreground">{category.appointmentCount.toLocaleString("en-US")} appointments</p>
              </div>
            </CardContent>
          </Card>
        ))}
