...
export function PricingCard({ plan }: { plan: PricingPlan }) {
  return (
    <div className={cn("relative h-full", plan.featured && "sm:scale-[1.03]")}>
      {plan.featured && (
      ...
      <Card
        className={cn(
          "h-full ring-foreground/5 transition-all duration-300 hover:-translate-y-1",
          plan.featured && "ring-2 ring-primary shadow-xl shadow-primary/10"
        )}
      >
